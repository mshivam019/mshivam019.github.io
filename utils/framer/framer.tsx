...
function Tabs({
  ...
  return (
    <nav
      ref={navRef}
      className="flex justify-center items-center relative z-0 py-2 w-full"
    ...
    >
        ...
        return (
          <motion.button
            ...
            className={classNames(
              'text-lg relative rounded-md flex w-full items-center h-10 px-4 z-20 bg-transparent cursor-pointer select-none transition-colors mb-0.5',
              {
      ...
      {selectedRect && navRect && (
        <motion.div
          className="absolute z-10 bottom-0 left-0.5 h-[3px] bg-zinc-700 dark:bg-zinc-200"
          initial={false}
          animate={{
